...
= "Тази опция е заключена";

bu_localizedStrings["Record no longer exists in Database, probably deleted by another user"]
= "Данните не съществуват в базата, вероятно са изтрити от друг потребител";
...
= "Не можете да публикувате празни съобщения";
