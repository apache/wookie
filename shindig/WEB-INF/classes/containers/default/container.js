...
"gadgets.iframeBaseUri" : "/wookie/gadgets/ifr",

// jsUriTemplate will have %host% and %js% substituted.
// No locked domain special cases, but jsUriTemplate must
// never conflict with a lockedDomainSuffix.
"gadgets.jsUriTemplate" : "http://%host%/wookie/gadgets/js/%js%",
...
"gadgets.osDataUri" : "http://%host%/wookie/social/rpc",
...
"gadgets.features" : {
  "core.io" : {
    ...
    "proxyUrl" : "http://%host%/wookie/gadgets/proxy?url=%url%",	
	// Note: SBW changed to wookie whitelist proxy
    //"proxyUrl" : "http://%host%/wookie/proxy?instanceid_key=gadgetsdefaultkey&url=%url%",
    "jsonProxyUrl" : "http://%host%/wookie/gadgets/makeRequest"
  },
  "views" : {
    "profile" : {
      "isOnlyVisible" : false,
      "urlTemplate" : "http://localhost/wookie/gadgets/profile?{var}",
      "aliases": ["DASHBOARD", "default"]
    },
    "canvas" : {
      "isOnlyVisible" : true,
      "urlTemplate" : "http://localhost/wookie/gadgets/canvas?{var}",
      "aliases" : ["FULL_PAGE"]
    }
  },
  "rpc" : {
    ...
    "parentRelayUrl" : "/wookie/gadgets/files/container/rpc_relay.html",
