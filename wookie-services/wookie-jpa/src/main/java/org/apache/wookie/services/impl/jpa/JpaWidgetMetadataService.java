...
public class JpaWidgetMetadataService implements WidgetMetadataService {
	...
	public void removeWidget(IWidget widget) {
		...
		for(IWidgetInstance instance : instances){
			...
			PreferencesService.Factory.getInstance().removePreferences(instance.getApiKey(), instance.getWidget().getIdentifier(), instance.getSharedDataKey(), instance.getUserId());
