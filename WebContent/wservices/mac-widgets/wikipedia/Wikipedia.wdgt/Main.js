...
function setLanguage(language) {
	...
	switch (langcode) {
		...
		case "ro": langname = "Român?"; break;
		case "sr": langname = "??????"; break;
		case "sl": langname = "Slovenš?ina"; break;
