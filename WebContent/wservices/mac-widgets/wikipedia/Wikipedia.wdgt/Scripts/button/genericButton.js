...
function createGenericButton (div, title, onaction, minwidth)
{
	...
	element.src = 'http://localhost:8081/wookie/shared/mac-resources/WidgetResources/button/glassbuttonleft.png';
	div.appendChild (element);
	
	element = document.createElement('div');
	element.setAttribute ("style", 'font:12px "Helvetica Neue";font-weight:bold;color:white;display:inline-block;text-align:center;line-height:23px;background:url(http://localhost:8081/wookie/shared/mac-resources/WidgetResources/button/glassbuttonmiddle.png) repeat-x top left;');	
	div.appendChild (element);
	...
	element.src = 'http://localhost:8081/wookie/shared/mac-resources/WidgetResources/button/glassbuttonright.png';
	div.appendChild (element);
	...
	var img = new Image;
	img.src = 'http://localhost:8081/wookie/shared/mac-resources/WidgetResources/button/glassbuttonleftclicked.png';
	var img = new Image;
	img.src = 'http://localhost:8081/wookie/shared/mac-resources/WidgetResources/button/glassbuttonmiddleclicked.png';
	var img = new Image;
	img.src = 'http://localhost:8081/wookie/shared/mac-resources/WidgetResources/button/glassbuttonrightclicked.png';
}
...
function genericButtonMouseDownHandler(event, div)
{
	...
	{
		div.childNodes[0].src = 'http://localhost:8081/wookie/shared/mac-resources/WidgetResources/button/glassbuttonleftclicked.png';
		div.childNodes[1].style.backgroundImage = 'url(http://localhost:8081/wookie/shared/mac-resources/WidgetResources/button/glassbuttonmiddleclicked.png)';
		div.childNodes[2].src = 'http://localhost:8081/wookie/shared/mac-resources/WidgetResources/button/glassbuttonrightclicked.png';
	}
...
function genericButtonMouseOverHandler (event)
{
	...
	{
		genericButtonCurrentMouseDownButton.childNodes[0].src = 'http://localhost:8081/wookie/shared/mac-resources/WidgetResources/button/glassbuttonleftclicked.png';
		genericButtonCurrentMouseDownButton.childNodes[1].style.backgroundImage = 'url(http://localhost:8081/wookie/shared/mac-resources/WidgetResources/button/glassbuttonmiddleclicked.png)';
		genericButtonCurrentMouseDownButton.childNodes[2].src = 'http://localhost:8081/wookie/shared/mac-resources/WidgetResources/button/glassbuttonrightclicked.png';
	}
...
function genericButtonMouseOutHandler (event)
{
	if (genericButtonCurrentMouseDownButton && genericButtonCurrentMouseDownButton.genericButtonEnabled)
	{
		genericButtonCurrentMouseDownButton.childNodes[0].src = 'http://localhost:8081/wookie/shared/mac-resources/WidgetResources/button/glassbuttonleft.png';
		genericButtonCurrentMouseDownButton.childNodes[1].style.backgroundImage = 'url(http://localhost:8081/wookie/shared/mac-resources/WidgetResources/button/glassbuttonmiddle.png)';
		genericButtonCurrentMouseDownButton.childNodes[2].src = 'http://localhost:8081/wookie/shared/mac-resources/WidgetResources/button/glassbuttonright.png';
	}
