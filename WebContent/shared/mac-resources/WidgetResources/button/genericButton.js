...
function createGenericButton (div, title, onaction, minwidth)
{
	...
	element.src = 'glassbuttonleft.png';
	div.appendChild (element);
	
	element = document.createElement('div');
	element.setAttribute ("style", 'font:12px "Helvetica Neue";font-weight:bold;color:white;display:inline-block;text-align:center;line-height:23px;background:url(glassbuttonmiddle.png) repeat-x top left;');	
	div.appendChild (element);
	...
	element.src = 'glassbuttonright.png';
	div.appendChild (element);
	...
	var img = new Image;
	img.src = 'glassbuttonleftclicked.png';
	var img = new Image;
	img.src = 'glassbuttonmiddleclicked.png';
	var img = new Image;
	img.src = 'glassbuttonrightclicked.png';
}
...
function genericButtonMouseDownHandler(event, div)
{
	...
	{
		div.childNodes[0].src = 'glassbuttonleftclicked.png';
		div.childNodes[1].style.backgroundImage = 'url(glassbuttonmiddleclicked.png)';
		div.childNodes[2].src = 'glassbuttonrightclicked.png';
	}
...
function genericButtonMouseOverHandler (event)
{
	...
	{
		genericButtonCurrentMouseDownButton.childNodes[0].src = 'glassbuttonleftclicked.png';
		genericButtonCurrentMouseDownButton.childNodes[1].style.backgroundImage = 'url(glassbuttonmiddleclicked.png)';
		genericButtonCurrentMouseDownButton.childNodes[2].src = 'glassbuttonrightclicked.png';
	}
...
function genericButtonMouseOutHandler (event)
{
	if (genericButtonCurrentMouseDownButton && genericButtonCurrentMouseDownButton.genericButtonEnabled)
	{
		genericButtonCurrentMouseDownButton.childNodes[0].src = 'glassbuttonleft.png';
		genericButtonCurrentMouseDownButton.childNodes[1].style.backgroundImage = 'url(glassbuttonmiddle.png)';
		genericButtonCurrentMouseDownButton.childNodes[2].src = 'glassbuttonright.png';
	}
