...
/**
 * DescriptionImpl - JCR OCM IDescription implementation.
 * 
 * @author <a href="mailto:rwatler@apache.org">Randy Watler</a>
 * @version $Id$
 */
@Node(jcrType="wookie:description", extend=LocalizedBeanImpl.class, discriminator=false)
public class DescriptionImpl extends LocalizedBeanImpl implements IDescription, IIdElement
{
